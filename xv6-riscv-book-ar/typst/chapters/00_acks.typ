...
تتبع `xv6` بمرونة تركيب وأسلوب v6،
ولكنها تُنفذ بـ ANSI C لمعالج RISC-V متعدد النوى.

ينبغي قراءة هذا النص جنباً إلى جنب مع الشفرة المصدرية لـ `xv6`،
وهو نهج مستوحى من تعليقات John Lions على الإصدار السادس من UNIX؛
ويحتوي النص على وصلات شعبية للشفرة المصدرية عند #link("https://github.com/mit-pdos/xv6-riscv").
انظر #link("https://pdos.csail.mit.edu/6.1810") لمؤشرات إضافية للموارد على الشبكة لـ v6 و `xv6`،
بما بداخل ذلك عدة واجبات معملية تستخدم `xv6`.

لقد استخدمنا هذا النص بداخل المقررات 6.828 و 6.1810،
فصول نظم التشغيل بـ MIT.
نشكر أعضاء هيئة التدريس،
المساعدين التعليميين،
والطلاب بداخل تلك الفصول الذين ساهموا جميعاً مباشرة أو غير مباشرة بـ `xv6`.
وبصفة خاصة،
نود شكر Adam Belay و Austin Clements و Nickolai Zeldovich.
أخيراً نود شكر الأشخاص الذين أرسلوا لنا بريداً إلكترونياً بأخطاء بداخل النص أو اقتراحات للتحسينات:
...
إذا لاحظت أخطاء أو حزت اقتراحات للتحسين،
يُرجى إرسال بريد إلكتروني لـ Frans Kaashoek و Robert Morris على (`kaashoek,rtm@csail.mit.edu`).
