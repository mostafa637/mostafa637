= المقدمة والشكر والتقدير

هذا النص هو مسودة معدّة لمقرر دراسي في أنظمة التشغيل. يوضح المفاهيم الأساسية لأنظمة التشغيل من خلال دراسة نواة نموذجية تُدعى xv6. تقتدي xv6 بنظام Unix الإصدار السادس (v6) الذي طوره دينيس ريتشي (Dennis Ritchie) وكين ثومبسون (Ken Thompson)~[unix]. تتبع xv6 البنية والأسلوب العام لـ v6، ولكن تم تنفيذها بلغة ANSI C~[kernighan] لمعمارية RISC-V متعددة الأنوية~[riscv].

يجب قراءة هذا النص بالتزامن مع الشفرة المصدرية لـ xv6، وهو نهج مستوحى من كتاب جون ليونز "تعليق على نظام UNIX الإصدار السادس" (John Lions' Commentary on UNIX 6th Edition)~[lions]؛ يحتوي النص على وصلات شعبية للشفرة المصدرية على #link("https://github.com/mit-pdos/xv6-riscv")[https://github.com/mit-pdos/xv6-riscv]. انظر #link("https://pdos.csail.mit.edu/6.1810")[https://pdos.csail.mit.edu/6.1810] للحصول على مؤشرات إضافية للموارد المتاحة على الإنترنت الخاصة بـ v6 و xv6، بما في ذلك العديد من الواجبات المعملية (Labs) التي تستخدم xv6.
