...
في تصميم مُقيِّم التحكم الصريح، يجب علينا تحديد العمليات المراد استخدامها في آلة المسجّلات الخاصة بنا. وصفنا المُقيِّم ما فوق الدائري بدلالة البناء التجريدي، باستخدام دوال مثل #py("is_literal") و #py("make_function"). في تنفيذ آلة المسجّلات، يمكننا توسيع هذه الدوال إلى تسلسلات من عمليات ذاكرة بنية القائمة الأوّلية، وتنفيذ هذه العمليات على آلة المسجّلات الخاصة بنا. ومع ذلك، فإن هذا سيجعل مُقيِّمنا طويلاً جداً، مما يطمس البنية الأساسية بالتفاصيل. لتوضيح العرض، سنضمّن كـ عمليات أوّلية لآلة المسجّلات دوال البناء المعطاة في القسم @sec:representing-expressions والدوال لتمثيل البيئات وبيانات وقت التشغيل الأخرى المعطاة في القسمين @sec:eval-data-structures و @sec:running-eval.
