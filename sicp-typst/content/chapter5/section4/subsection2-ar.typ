...
كما هو الحال في المُقيِّم فوق الدائري (#en[metacircular])، تُحول تركيبات المُعاملات إلى تطبيقات للدوال الأوّلية المقابلة للمُعاملات. يتم ذلك عند #py("ev_operator_combination")، والتي تنفذ هذا التحويل في مكانه في #py("comp") وتنتقل إلى #py("ev_application").#footnote[نفترض أن محول البناء #py("operator_combination_to_application") متاح كعملية آلة. في تنفيذ فعلي مبني من الصفر، سنستخدم مُقيِّم التحكم الصريح الخاص بنا لتفسير برنامج بايثون ينفذ تحويلات على مستوى المصدر مثل هذا التحويل و #py("function_decl_to_constant_decl") في مرحلة بناء تعمل قبل التنفيذ.]<foot:syntax-transformer>
...
الدوال المركبة. لتطبيق دالة مركبة، نواصل بطريقة مماثلة لما فعلناه في المُقيِّم فوق الدائري. نبني إطارًا يربط معاملات الدالة بالوسائط، ونستخدم هذا الإطار لتوسيع البيئة المحمولة بواسطة الدالة، ونُقيّم جسم الدالة في هذه البيئة الممتدة.
