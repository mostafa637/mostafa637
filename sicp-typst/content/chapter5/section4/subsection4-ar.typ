...
يجب علينا تعريف دوال #en[Python] لمُحاكاة العمليات المستخدمة كأوّليات بواسطة المُقيِّم. هذه هي نفس الدوال التي استخدمناها للمُقيِّم فوق الدائري في القسم @sec:mc-eval، جنبًا إلى جنب مع عدد قليل من الدوال الإضافية المحددة في الحواشي السفلية في جميع أنحاء القسم @sec:eceval.
