...
في القسم @sec:separating-analysis عدلنا مُفسِّرنا ما فوق الدائري الأصلي لفصل
...
- القفز إلى نقطة إدخال معنونة (يحدد هذا باستخدام التسمية المحددة كـ واصف ارتباط).
