...
تسلسل التعليمتين المُلحق يتطلب #py("env") و #py("val") ويعدل الهدف. لاحظ أنه على الرغم من أننا نحفظ #py("env") لهذا التسلسل، إلا أننا لا نحفظ #py("val")، لأن #py("get_value_code") صُمم ليضع نتيجته صراحة في #py("val") لاستخدامها بواسطة هذا التسلسل.
...
تبني الدالة #py("compile_lambda_body") الكود لجسم الدالة. يبدأ هذا الكود بتسمية لنقطة الإدخال. ثم تأتي التعليمات التي ستتسبب في تبديل بيئة التقييم في وقت التشغيل إلى البيئة الصحيحة لتقييم جسم الدالة—أي بيئة الدالة، ممتدة لتشمل روابط المعلمات بالوسائط التي استُدعيت بها الدالة. بعد ذلك يأتي الكود لجسم الدالة، معززاً لضمان انتهائه بتعليمة إرجاع.
...
#py("undefined").
في المُقيِّم فوق الدائري (#en[metacircular])، استخدمنا كائن قيمة إرجاع، والذي لعب دورًا أيضًا في إيقاف تقييم التسلسل.
