...
لن نناقش كيفية صنع آلة يمكنها القراءة والطباعة، ولكننا سنفترض (كما نفعل عندما نستخدم #py("prompt") و #py("display") في بايثون) أنها متوفرة كعمليات أولية.#footnote[يخفي هذا الافتراض قدرًا كبيرًا من التعقيد. يتطلب تنفيذ القراءة والطباعة جهدًا كبيرًا، على سبيل المثال للتعامل مع ترميزات الأحرف للغات المختلفة.]
