...
في القسم @sec:hierarchical-data سنرى كيف تعني هذه القدرة على دمج الأزواج أنه يمكن استخدام الأزواج كلبنات بناء عامة الغرض لإنشاء جميع أنواع هياكل البيانات المعقدة. وتعتبر الآلية الأولية الوحيدة للبيانات المركبة #emph[الزوج]، المنفذة بالدوال #py("pair") و #py("head") و #py("tail")، هي الغراء الوحيد الذي نحتاجه. وتُسمّى كائنات البيانات المنشأة من الأزواج
#idx("list structure")
...
عرِّف نسخة أفضل من #py("make_rat") تتعامل مع كل من المعطيات الموجبة والسالبة.
