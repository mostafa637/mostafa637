...
+ في هذا المتلاعب الجبري البسيط، يكون نوع التعبير هو العامل الجبري الذي يربطه معاً. ولكن نفترض أننا فهرسنا الدوال بالطريقة المعاكسة، بحيث بدا سطر الإرسال في #py("deriv") ك#snippet(```python get(operator(exp), "deriv")(operands(exp), variable) ```) ما هي التغييرات المقابلة لنظام المشتقة المطلوبة؟
])
