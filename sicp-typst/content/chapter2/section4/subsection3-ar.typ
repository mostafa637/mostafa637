...
يمكننا اعتبار هذا البرنامج مكملاً لإرسالٍ بناءً على نوع التعبير المراد تفاضله. وفي هذه الحالة يكون "وسم النوع" للبيانات هو رمز العامل الجبري (مثل "+") والعملية التي تُؤدَّى هي #py("deriv"). ويمكننا تحويل هذا البرنامج إلى أسلوب موجه بالبيانات عن طريق إعادة كتابة دالة المشتقة الأساسية كالتالي:
