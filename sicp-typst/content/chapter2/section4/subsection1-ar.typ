...
سنطور نظاماً يؤدي عمليات حسابية على الأعداد المركبة كمثال بسيط ولكنه غير واقعي لبرنامج يستخدم عمليات عامة. نبدأ بمناقشة تمثيلين معقولين للأعداد المركبة كأزواج مرتبة: الشكل المستطيلي (الجزء الحقيقي والجزء التخيلي) والشكل القطبي (السعة والزاوية).#footnote[في الأنظمة الحسابية الفعلية، يُفضل الشكل المستطيلي على الشكل القطبي معظم الوقت بسبب #idx("roundoff error") أخطاء التقريب في التحويل بين الشكلين المستطيلي والقطبي. ولهذا السبب يعتبر مثال العدد المركب غير واقعي. ومع ذلك، فإنه يوفر توضيحاً واضحاً لتصميم نظام يستخدم عمليات عامة ومقدمة جيدة للأنظمة الأكثر أهمية المراد تطويرها لاحقاً في هذا الفصل.] وسيبين القسم @sec:manifest-types كيف يمكن جعل كلا التمثيلين يتعايشان في نظام واحد من خلال استخدام وسوم الأنواع والعمليات العامة.

مثل الأعداد الكسرية، تُمثَّل الأعداد المركبة طبيعياً كأزواج مرتبة. ويمكن التفكير في مجموعة الأعداد المركبة كمساحة ثنائية الأبعاد بمحورين متعامدين، المحور "الحقيقي" والمحور "التخيلي" (انظر الشكل @fig:complex-plane). ومن وجهة النظر هذه، يمكن التفكير في العدد المركب $z=x+i y$ (حيث $i^(2) = -1$) كالنقطة في المستوى التي إحداثيها الحقيقي هو $x$ وإحداثيها التخيلي هو $y$. وينحصر جمع الأعداد المركبة في هذا التمثيل في جمع الإحداثيات:
...
عند ضرب الأعداد المركبة، يكون من الطبيعي أكثر التفكير بدلالة تمثيل العدد المركب في الشكل القطبي، كالسعة والزاوية ($r$ و $A$ في الشكل @fig:complex-plane). وجداء عددَين مركبَين هو المتجه المحصول عليه بتمديد عدد مركب بطول الآخر ثم تدويره بزاوية الآخر (#idx("complex numbers", sub: "rectangular vs. polar form")):
...
وبالتالي، هناك تمثيلان مختلفان للأعداد المركبة، مناسبان لعمليات مختلفة. ومع ذلك، من وجهة نظر شخص يكتب برمجية تستخدم الأعداد المركبة، يقترح مبدأ تجريد البيانات أن جميع العمليات للتلاعب بالأعداد المركبة ينبغي أن تكون متاحة بغض النظر عن التمثيل المستخدم بوساطة الحاسوب. فعلى سبيل المثال، من المفيد غالباً التمكن من العثور على سعة عدد مركب محدد بإحداثيات مستطيلية. وبالمثل، من المفيد غالباً التمكن من تحديد الجزء الحقيقي لعدد مركب محدد بإحداثيات قطبية.
...
لتصميم مثل هذا النظام، يمكننا اتباع استراتيجية #idx("data abstraction") تجريد البيانات نفسها التي اتبعناها في تصميم حزمة الأعداد الكسرية في القسم @sec:rationals. لنفترض أن العمليات على الأعداد المركبة منفذة بدلالة أربعة محددات:
#py("real_part")،
#py("imag_part")،
#py("magnitude")،
و #py("angle"). ولنفترض أيضاً أن لدينا دالتين لبناء الأعداد المركبة:
ترجع #py("make_from_real_imag") عدداً مركباً بأجزاء حقيقية وتخيلية محددة، وترجع
#py("make_from_mag_ang") عدداً مركباً بسعة وزاوية محددتين. وتملك هذه الدوال خاصية أنه، لأي عدد مركب #py("z")، فإن كلاً من:
...
يختار #en[Ben] تمثيل الأعداد المركبة في الشكل المستطيلي (#idx("complex numbers", sub: "rectangular representation")). ومع هذا الاختيار، فإن اختيار الأجزاء الحقيقية والتخيلية لعدد مركب أمر مباشر، وكما هو الحال في بناء عدد مركب بأجزاء حقيقية وتخيلية معطاة. ولإيجاد السعة والزاوية، أو لبناء عدد مركب بسعة وزاوية معطاتين، فإنه يستخدم العلاقات المثلثية:

$ mat(delim: #none, x, =, r space cos A, , r, =, sqrt(x^(2) +y^(2)); y, =, r space sin A, , A, =, arctan (y,x)) $

والتي تربط الأجزاء الحقيقية والتخيلية ($x$, $y$) بالسعة والزاوية $(r, A)$.#footnote[دالة الظل العكسي (#idx("arctangent") #idx("mathatan2 (primitive function)")) المشار إليها هنا، والمحسوبة بوساطة دالة #en[Python] #py("math_atan2")، معرّفة بحيث تأخذ وسيطين $y$ و $x$ وترجع الزاوية التي ظلها $y/x$. وتحدد إشارات الوسيطين ربع الزاوية.]
وبالتالي يُعطى تمثيل #en[Ben] بوساطة المحددات والمُنشِئات التالية:
