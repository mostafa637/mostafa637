...
#py("llist(\"a\", \"*\", \"x\", \"+\", \"b\")").
ومع ذلك، سيكون من الأكثر ملاءمة أن نعكس البنية الرياضية للتعبير في قيمة #en[Python] التي تمثله؛ أي تمثيل $a x + b$ كـ #py("llist(\"+\", llist(\"*\", \"a\", \"x\"), \"b\")"). وتسمى ممارسة وضع العامل الثنائي أمام معاملاته بـ #idx("prefix notation") #emph[الترميز البادئي] (#en[prefix notation])، على النقيض من الترميز الإقحامي المعتاد المألوف. ومع الترميز البادئي، يكون تمثيل بياناتنا لمشكلة التفاضل كما يلي:
