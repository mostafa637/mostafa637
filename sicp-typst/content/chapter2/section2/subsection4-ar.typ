...
ويمكن التعبير عن #py("square_limit") كالتالي:#footnote[تدور الدالة #py("rotate180") الرسّام بمقدار 180 درجة. وبدلاً من #py("rotate180") كان بإمكاننا قول #py("compose(flip_vert, flip_horiz)")، باستخدام دالة #py("compose") من التمرين @ex:compose.]
#idx("squarelimit", decl: true)
#snippet(```python
def square_limit(painter, n):
