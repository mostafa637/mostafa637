...
#idx("painter(s)")
#emph[رسّام] (#en[painter]). يرسم الرسّام صورة تُزاح ويُغيَّر مقياسها لتناسب
#idx("frame (picture language)")
إطاراً معيناً على شكل متوازي أضلاع. فعلى سبيل المثال، هناك رسّام أولي سنسميه #py("wave")
