...
وهذه الدالةُ التي تبني قائمة الحدود لمجموع حدوديتين؛#footnote[هذه العملية تشبه كثيراً العملية المرتبة #py("union_set") التي طوّرناها في التمرين @ex:union-set.
...
ولضرب قائمتي حدود، نضرب كل حد من القائمة الأولى في جميع حدود القائمة الأخرى، مستخدمين بشكل متكرر
