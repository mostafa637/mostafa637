...
والآن سنرى كيفية استخدام الفكرة نفسها ليس فقط لتعريف عمليات عامة عبر تمثيلات مختلفة، بل وأيضاً لتعريف عمليات عامة عبر أنواع مختلفة من المعاملات (#idx("arithmetic", sub: "generic")). وقد رأينا بالفعل عدة حزم مختلفة من العمليات الحسابية: الحساب الأولي
(#py("+")، #py("-")، #py("*")، #py("/"))
