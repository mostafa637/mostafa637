...
يمكننا الرجوع إلى نموذج البيئة لرؤية كيفية استخدام الدوال والإسناد لتمثيل كائنات ذات حالة محلية. كمثال، فكر في
...
نبدأ، كالمعتاد، بإنشاء بيئة E1 يُربط فيها المعلمة #py("balance") بالوسيط 100. وداخل هذه البيئة، نقوم بتقييم جسم #py("make_withdraw")، أي تعليمة الإرجاع التي تعبير إرجاعها هو تعبير لامدا. وينتج عن تقييم تعبير لامدا هذا كائن دالة جديد، تكون شفرته كما هو محدد بتعبير لامدا وتكون بيئته هي E1، البيئة التي أُقيِّم فيها تعبير لامدا لإنتاج الدالة.
...
نبدأ بإنشاء إطار يُربط فيه #py("amount")، معلمة #py("W1")، بالوسيط 50. والنقطة الحاسمة التي يجب ملاحظتها هي أن هذا الإطار له كبيئته المحيطة ليس بيئة البرنامج، بل البيئة E1، لأن هذه هي البيئة المحددة بوساطة كائن الدالة #py("W1"). وداخل هذه البيئة الجديدة، نقوم بتقييم جسم الدالة:
...
في دالة #py("make_withdraw") يُنشأ المتغير المحلي #py("balance") كمعلمة لـ #py("make_withdraw").
