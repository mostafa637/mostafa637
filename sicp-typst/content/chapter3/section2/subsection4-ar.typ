...
لذلك أُستدعي كائن الدالة المرتبط بـ #py("sqrt_iter") في E2 مع كون 1 كوسيط. ينشئ هذا بيئة E3 يُربط فيها #py("guess")، معامل #py("sqrt_iter")، بـ 1.
...
- يمكن للدوال المحلية الوصول إلى وسائط الدالة المحيطة، بمجرد استخدام أسماء المعاملات كأسماء حرة. وذلك لأن جسم الدالة المحلية يُقيّم في بيئة تابعة لبيئة التقييم للدالة المحيطة.
