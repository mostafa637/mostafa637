...
ينشئ الاستدعاء لـ #py("f") بيئة جديدة، E1، تبدأ بإطار يُربط فيه #py("a")، معامل #py("f")، بالوسيط 5. وفي E1، نقوم بتقييم جسم #py("f"):
...
والآن نطبق كائن الدالة #py("sum_of_squares") على الوسيطين 6 و 10. ينتج عن هذا بيئة جديدة، E2، يُربط فيها المعاملان #py("x") و #py("y") بالوسيطين. وداخل E2 نقوم بتقييم التعليمة #snippet(```python return square(x) + square(y) ```)
...
وأيضاً كجزء من تطبيق #py("sum_of_squares")، يجب أن نقيم التعبير الفرعي #py("square(y)")، حيث #py("y") تساوي 10. ينشئ هذا الاستدعاء الثاني لـ #py("square") بيئة أخرى، E4، يُربط فيها #py("x")، معامل #py("square")، بـ 10. وداخل E4 يجب أن نقيم #py("return x * x").
