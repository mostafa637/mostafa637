...
#section([Assignment and Local State], label-name: <sec:assignment>)
...
#idx("state variable")
#emph[state variables], which among them maintain enough
...
own #emph[local state variables] describing the actual object's
...
provide an
#idx("assignment", sub: "assignment operation") #emph[assignment operation]
to enable us to change the value
associated with a name.

#include "../../chapter3/section1/subsection1.typ"

#include "../../chapter3/section1/subsection2.typ"

#include "../../chapter3/section1/subsection3.typ"
