...
(1977) أساساً دلالياً متماسكاً للعودية الذيلية، وشرحها من حيث
#idx("message passing", sub: "tail recursion and")
نموذج «تمرير الرسائل» للحساب الذي سنناقشه في الفصل @chap:state. وإلهاماً من هذا، قام جيرالد جاي سسمان و
