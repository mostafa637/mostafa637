...
المحمول الأولي #py(">=")، وهو عامل يأخذ عددين كوسيطين ويختبر ما إذا كان
...
بالإضافة إلى المحمولات الأولية مثل
#idx("> (numeric comparison operator)")
...
وسيطاً واحداً فقط، بينما العوامل الحسابية والمحمولات الأولية المناقَشة حتى الآن
