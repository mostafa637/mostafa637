...
- الأعداد والعمليات الحسابية هي بيانات ودوال أولية.
...
الذي سيُنتج قيمة تطبيق الدالة حين تُستبدل المعلمات بالوسائط الفعلية التي
...
ينطبق الإجراء ذاته على تطبيقات الدالة الأولية #py("print") التي صادفناها
...
دوالاً أولية مدمجة في المُفسِّر أو مُحمَّلة من مكتبات.
#idx("Python environment used in this book")
إلى جانب الدوال الأولية التي توفّرها العوامل والدالة الأولية #py("print")،
تتضمّن بيئة بايثون المستخدمة في هذا الكتاب دوالاً أولية إضافية مثل الدالة
#idx("mathlog (primitive function)")
#py("math_log") التي تحسب اللوغاريتم الطبيعي لوسيطها. تُستخدم هذه الدوال
الأولية الإضافية بنفس طريقة
