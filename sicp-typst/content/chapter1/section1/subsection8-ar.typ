...
معاملات الدالة. وهكذا يجب ألا تكون الدالتان التاليتان قابلتين للتمييز:
...
هذا المبدأ — أنّ معنى الدالة يجب أن يكون مستقلاً عن أسماء المعاملات التي
استخدمها مؤلفها — يبدو على السطح بديهياً، لكن عواقبه عميقة. أبسط عاقبة هي أنّ
أسماء معاملات الدالة يجب أن تكون محلية لجسم الدالة. مثلاً، استخدمنا #py("square")
...
لو لم تكن المعاملات محلية لأجسام دوالها، لأمكن الخلط بين المعامل #py("x") في
#py("square") والمعامل #py("x") في #py("is_good_enough")، ولاعتمد سلوك
...
للمعامل في الدالة دور خاص جداً في تعريف الدالة، إذ لا يهمّ ما اسمه. يُسمّى
هذا الاسم
#idx("bound name") #idx("name", sub: "bound") #emph[مقيَّداً]، ونقول إنّ تعريف الدالة
#idx("bind")
#emph[يُقيّد] معاملاته. معنى تعريف الدالة لا يتغيّر إذا أُعيدت تسمية اسم
...
كمعاملات للدالة نطاقها هو جسم الدالة.
...
لدينا حتى الآن نوع واحد من عزل الأسماء: معاملات الدالة محلية لجسم الدالة.
