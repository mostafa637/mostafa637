...
من أسهل الطرق للدخول في عالم البرمجة أن نتأمل بعض التفاعلات النموذجية
مع مُفسِّر لغة بايثون.
...
#idx("expression")
نوع من التعبيرات الأولية هو العدد.
...
نحتاج لتطبيق الدالة الأولية #py("print")
...
تعبير مركّب يمثّل تطبيق دالة أولية مقابلة على تلك الأعداد. مثلاً:
...
#emph[معمولات] (#en[operands]) على جانبيه، تُسمّى
#emph[تركيبات العوامل].
#idx("value", sub: "of an expression")
ونحصل على قيمة تركيبة العوامل بتطبيق الدالة التي يحددها العامل على
الوسائط، وهي قيمُ المعمولات.

يُعرف اصطلاح وضع العامل بين المعمولات بالترميز
#idx("infix operator")
#idx("infix notation")
...
#emph[متداخلة]، أي يمكن أن تحتوي على معمولات
