...
وبالمثل، كمصممي برامج، نودّ أن تكون لغتنا قوية بدرجة كافية بحيث يمكننا كتابة دالة تعبر عن مفهوم الجمع ذاته بدلاً من كتابة دوال فقط تحسب مجاميع محددة. ويمكننا القيام بذلك بسهولة في لغتنا الوظيفية بآخذ القالب المشترك المعروض أعلاه وتحويل «الفراغات» إلى معلمات:
#idx("sum", decl: true)
#snippet(```python
