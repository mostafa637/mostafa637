...
باستثناء أنه لا يُحدَّد اسم للدالة وتُحذَف الأقواس حول المعاملات وكلمة #py("return") المفتاحية.
...
غالباً ما نحتاج إلى متغيرات محلية في دوالنا غير تلك التي رُبِطَت كمعاملات.
...
$""^(,)$
#footnote[يمكن توسيع نموذج الاستبدال للقول إنه بالنسبة لإسناد التعيين، تُستبدَل قيمة التعبير بعد #py("=") بالاسم قبل #py("=") في بقية جسم الدالة (بعد التصريح)، بشكل مشابه لاستبدال المعطيات بالمعاملات في تقييم تطبيق الدالة.]
#idx("local name")
