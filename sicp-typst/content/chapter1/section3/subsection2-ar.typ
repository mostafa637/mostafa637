...
القسم @sec:procedures-as-parameters، يبدو من المربك للغاية اضطرارنا لتعريف دوال بسيطة مثل #py("pi_term") و #py("pi_next") لمجرد استخدامها كوسائط لدالتنا ذات الرتبة الأعلى. وبدلاً من تعريف #py("pi_next") و #py("pi_term")، سيكون من الأكثر ملاءمة إيجاد طريقة لتحديد «الدالة التي ترجع مدخلها مضافاً إليه 4» و «الدالة التي ترجع مقلوب مدخلها مضروباً في مدخلها زائد 2» مباشرة. ويمكننا القيام بذلك بتقديم #emph[تعبير لامبدا] كشكل نحوي لإنشاء الدوال.
باستخدام تعبيرات لامبدا، يمكننا وصف ما نريده كالتالي:
...
والتي يمكننا التعبير عنها أيضاً كالتالي:
...
باستخدام إسناد التعيين، يمكن كتابة الدالة كالتالي:
...
هذا من شأنه أن يجعل الدالة ليست فقط غير كفؤة، بل وغير منتهية بالفعل! والمشكلة هي أنّ إسناد التعيين يظهر خارج التعبير الشرطي، مما يعني أنه يُنفَّذ حتى عندما تتحقق حالة الأساس #py("exp == 0").
