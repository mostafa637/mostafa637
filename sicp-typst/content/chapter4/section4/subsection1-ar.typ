...
تبدو التقريرات الجازمة تمامًا مثل تطبيقات الدوال في #en[Python]، ولكنها تمثل في الواقع معلومات في قاعدة البيانات. وتصف الرموز الأولى — هنا #py("address") و#py("job") و#py("salary") — #emph[نوع المعلومات] المحتواة في التقرير الجازم المعني، والوسائط عبارة عن قوائم أو قيم أوليّة مثل السلاسل النصية والأعداد. ولا يلزم التصريح عن الرموز الأولى، كما هو الحال مع الثوابت أو المتغيرات في #en[Python]؛ فنطاقها عام.
