...
وطلب إعادة المحاولة من المُقيِّم ينتج
...
المُقيِّمات في الأقسام @sec:mc-eval و @sec:lazy-evaluation لا تحدد الترتيب الذي تُقَيَّم به تعبيرات الوسائط. وسنرى أن مُقَيِّم #py("amb") يُقَيِّمها من اليسار إلى اليمين. وضح لماذا لن يعمل برنامج التحليل الخاص بنا إذا قُيِّمت تعبيرات الوسائط بترتيب آخر.
])
