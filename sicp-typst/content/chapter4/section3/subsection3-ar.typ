...
تذكر أن دوال التنفيذ للمُقَيِّم الاعتيادي تأخذ وسيطًا واحدًا: بيئة التنفيذ. وعلى النقيض من ذلك، تأخذ دوال التنفيذ في مُقَيِّم #py("amb") ثلاثة وسائط: البيئة، ودالتان تُسميان #emph[دوال المتابعة] (#en[continuation functions]).
