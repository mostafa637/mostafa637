...
الدوال الأولية.
ولذلك، فإن كل ما نحتاجه لتشغيل المُقيِّم هو إنشاء آلية تستدعي نظام Python الأساسي لنمذجة تطبيق الدوال الأولية.

يجب أن يكون هناك ارتباط لكل اسم دالة أولية وعامل، بحيث عندما تُقيّم
#py("evaluate")
تعبير الدالة لـ تطبيق دالة أولية، ستعثر على كائن لترفق به #py("apply"). وهكذا نُعد
#idx("metacircular evaluator for Python", sub: "global environment")
#idx("global environment", sub: "in metacircular evaluator")
بيئة عالمية تربط كائنات فريدة بأسماء الدوال الأولية والعوامل التي يمكن أن تظهر في التعبيرات التي سنقوّم بتقييمها.
...
لا يهم كيف نمثل كائنات الدوال الأولية، طالما أن #py("apply") يمكنها التعرف عليها وتطبيقها باستخدام الدوال #py("is_primitive_function") و #py("apply_primitive_function"). ولقد اخترنا تمثيل الدالة الأولية كقائمة تبدأ بالسلسلة النصية #py("\"primitive\"") وتحتوي على دالة في JavaScript الأساسية تنفذ تلك الدالة الأولية.
...
ستحصل الدالة #py("setup_environment") على أسماء الدوال الأولية ودوال التنفيذ من قائمة:#footnote[أي دالة معرفة في Python الأساسية يمكن استخدامها كدالة أولية للمُقيِّم دائري التجريد. ولا يلزم أن يكون اسم الدالة الأولية المُثبتة في المُقيِّم هو نفسه اسم تنفيذها في Python الأساسية؛ والأسماء هي نفسها هنا لأن المُقيِّم دائري التجريد ينفذ Python نفسها.
...
وبشكل مماثل للدوال الأولية، نُعرّف ثوابت أولية أخرى تُثبَّت في البيئة العالمية بواسطة الدالة #py("setup_environment").
...
وتُحول السلسلة النصية للبرنامج إلى تمثيل قائمة مُعنونة للعبارة كما هو موضح في القسم @sec:representing-expressions—وهي عملية تُسمى الإعراب وتُنجز بواسطة الدالة الأولية #py("parse").
