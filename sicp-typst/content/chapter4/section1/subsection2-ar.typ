...
+ اكتب دالة #py("unparse") باتباع هيكل #py("evaluate") (دون وسيط البيئة)، ولكن بإنتاج سلسلة نصية تمثل المكون المعطى، بدلاً من تقييمه. تذكر من القسم @sec:circuit-simulator أن العامل #py("+") يمكن تطبيقه على سلسلتين نصيتين لربطهما وأن الدالة الأولية #py("stringify") تحول القيم مثل 1.5 و صح و #py("None") إلى سلاسل نصية. احرص على احترام أسبقيات العوامل بإحاطة السلاسل النصية الناتجة عن إلغاء إعراب تركيبات العوامل بالأقواس (دائماً أو عندما يكون ذلك ضرورياً).
