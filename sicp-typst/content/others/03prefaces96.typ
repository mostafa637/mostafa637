...
#matter([Prefaces to Structure and Interpretation of Computer Programs, 19961984])

#section([Preface to the Second Edition of SICP, 1996])

#epigraph([Is it possible that software is not like anything else, that it
is meant to be discarded: that the whole point is to
always see it as a soap bubble?], author: [Alan J. Perlis])
...
The World Wide Web site #link("https://mitpress.mit.edu/sites/default/files/sicp/index.html")[of MIT Press]
...
#section([Preface to the First Edition of SICP, 1984])

#epigraph([A computer is like a violin. You can imagine a novice trying first a
...
or a typewriter, until you learn how to use it.], author: [Marvin Minsky], title: ["Why Programming Is a Good Medium for Expressing Poorly-Understood and Sloppily-Formulated Ideas"])
...
#emph[procedural epistemology]—the study of the structure of
