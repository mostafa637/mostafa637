...
#matter([Foreword to Structure and Interpretation of Computer Programs, 1984], label-name: <sec:foreword84>)
...
Every reader should ask himself periodically "Toward what end, toward what end?"—but do not ask it too often lest you pass up the fun of
...
#align(left)[#emph[author: [Alan J. Perlis], title: [New Haven, Connecticut]]]
