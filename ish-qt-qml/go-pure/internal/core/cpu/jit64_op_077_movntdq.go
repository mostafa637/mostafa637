...
func jit64CompileCaseMOVNTDQ(ctx jit64CompileContext64) (microOp64, bool, error) {
	...
	return makeSSEMove64(ctx.address, uint8(ctx.inst.Len), destination, source), false, nil
}

func init() {
	jit64InstructionHandlers[x86asm.MOVNTDQ] = jit64CompileCaseMOVNTDQ
	jit64InstructionHandlers[x86asm.MOVNTPS] = jit64CompileCaseMOVNTDQ
}
