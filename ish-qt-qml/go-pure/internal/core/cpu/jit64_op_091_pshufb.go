...
func jit64CompileCasePSHUFB(ctx jit64CompileContext64) (microOp64, bool, error) {
	...
	return makeSSEShuffleBytes64(ctx.address, uint8(ctx.inst.Len), destination, source), false, nil
}

func init() {
	jit64InstructionHandlers[x86asm.PSHUFB] = jit64CompileCasePSHUFB
}
