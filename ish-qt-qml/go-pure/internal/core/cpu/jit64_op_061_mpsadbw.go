...
func jit64CompileCaseMPSADBW(ctx jit64CompileContext64) (microOp64, bool, error) {
	...
	return makeMPSADBW64(ctx.address, uint8(ctx.inst.Len), destination, source, uint8(immediate)), false, nil
}

func init() {
	jit64InstructionHandlers[x86asm.MPSADBW] = jit64CompileCaseMPSADBW
}
