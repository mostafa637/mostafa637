...
func jit64CompileCasePALIGNR(ctx jit64CompileContext64) (microOp64, bool, error) {
	...
	return makeSSEAlignRight64(ctx.address, uint8(ctx.inst.Len), destination, source, uint8(immediate)), false, nil
}

func init() {
	jit64InstructionHandlers[x86asm.PALIGNR] = jit64CompileCasePALIGNR
}
