...
func jit64CompileCaseAESIMC(ctx jit64CompileContext64) (microOp64, bool, error) {
	...
	return makeAESIMC64(ctx.address, uint8(ctx.inst.Len), destination, source), false, nil
}

func init() {
	jit64InstructionHandlers[x86asm.AESIMC] = jit64CompileCaseAESIMC
}
