...
static const char *const opcode_names[X86ASM_OP_COUNT] = {
    ...
    [X86ASM_OP_MOVDQA] = "movdqa", [X86ASM_OP_MOVDQU] = "movdqu", [X86ASM_OP_MOVNTDQA] = "movntdqa", [X86ASM_OP_MOVNTDQ] = "movntdq", [X86ASM_OP_LDDQU] = "lddqu", [X86ASM_OP_MOVUPD] = "movupd", [X86ASM_OP_MOVDDUP] = "movddup", [X86ASM_OP_MOVSHDUP] = "movshdup", [X86ASM_OP_MOVSLDUP] = "movsldup", [X86ASM_OP_MOVSS] = "movss", [X86ASM_OP_MOVSD_SCALAR] = "movsd",
                               ...
                               x86asm_instruction *instruction)
{
    ...
    if (second == 0x12 && pf2 && !p66 && !pf3) {
        ...
        instruction->opcode = X86ASM_OP_MOVDDUP;
        instruction->mode = mode;
        instruction->address_size = mode;
        instruction->data_size = 128;
        instruction->memory_bytes = source.kind == X86ASM_ARG_MEMORY ? 8 : 0;
    ...
    if (second == 0x12 && pf3 && !p66 && !pf2) {
        ...
        instruction->opcode = X86ASM_OP_MOVSLDUP;
        instruction->mode = mode;
        instruction->address_size = mode;
        instruction->data_size = 128;
        instruction->memory_bytes = source.kind == X86ASM_ARG_MEMORY ? 16 : 0;
                               ...
                               int mode, x86asm_instruction *instruction)
{
    ...
    if (opcode == 0x58 && p == 0) operation = X86ASM_OP_VADDPS;
        ...
        unary_vector = true;
    } else if (opcode == 0x12 && p == 2 && map == 1) {
        operation = X86ASM_OP_VMOVSLDUP;
        unary_vector = true;
    ...
    if (unary_vector && operation != X86ASM_OP_VMOVDDUP && operation != X86ASM_OP_VMOVSHDUP && operation != X86ASM_OP_VMOVSLDUP && vvvv != 15u) return X86ASM_ERR_UNRECOGNIZED;
    if ((operation == X86ASM_OP_VMOVDDUP || operation == X86ASM_OP_VMOVSHDUP || operation == X86ASM_OP_VMOVSLDUP) && vvvv != 0u) return X86ASM_ERR_UNRECOGNIZED;
    ...
    if (rm_argument.kind == X86ASM_ARG_MEMORY) {
        ...
        if (operation == X86ASM_OP_VMOVDDUP) instruction->memory_bytes = l ? 32 : 8;
