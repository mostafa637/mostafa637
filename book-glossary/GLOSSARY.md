...
MHz                                         ميجاهرتز
GHz                                         جيجاهرتز
Precision (of timer)                        دقة (المؤقت)
Accuracy (of timer)                         صحة (المؤقت)
...
*نهاية الجدول — النسخة الحادية عشرة (الصارمة)*
